...
import IPeripheryPaymentsWithFee from '@pollum-io/v2-periphery/artifacts/contracts/interfaces/IPeripheryPaymentsWithFee.sol/IPeripheryPaymentsWithFee.json'
