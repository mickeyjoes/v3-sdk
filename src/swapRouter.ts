...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@pollum-io/sdk-core'
...
import ISwapRouter from '@pollum-io/v2-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
